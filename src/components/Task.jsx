              ...
              <tbody>
                {task?.map((data) => (
                  <tr>
                    ...
                    <td
                      className={`${
                        data.status === true ? "checked" : "notchecked"
                      }`}
                    >
                      <Link to={`/view/${data.id}`} className="linkname">
                        {data.name}
                      </Link>
                    </td>
                    <td>
                      {data.status === true ? "Completed" : "Not Completed"}
                    </td>
                    <td>
                      <button
                        className="deletebtn"
                    ...
                    <td>
                      <Link to={`/edit/${data.id}`}>
                        <button className="editbtnn">Edit Task</button>
                      </Link>
                    </td>
                  </tr>
                ))}
